...
public class Army {
	...
	public static void main( String[] args ) {
		...
		army[4] = new Shield(army[4]);	//The soldier here is decorated with
		army[4] = new Sword(army[4]);	//a new shield and sword
...
/*
 The following three classes demonstrate the internal functionality behind decorator objects
*/
